...
- `dlog_filter.sh` — recommended log filters for narrowing TV/RPi output to Flutter-relevant tags. **Blocked on the secured TV emulator** (`sdb dlog` returns nothing there); works on real TVs in Developer Mode and the common emulator.
